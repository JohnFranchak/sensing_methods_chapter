...
Project needs dictate what is relevant for evaluation (overall metrics vs. bouts, absolute time vs. relative time, generalization to new exemplars vs. best prediction of current data). Continuous outcomes (Yao) for prevalence predictions. Distal comparison. Bout structure
